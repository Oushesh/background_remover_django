## Test view one image from Dropbox here:
## Link to image: https://replay.dropbox.com/share/VB2Z22hReJPnxti7
...
metadata, res = dbx.files_get_shared_link_file(link.url)
